#ifndef FERAL_ENGINE_MAXVALUES_H
#define FERAL_ENGINE_MAXVALUES_H

#define DEF_ASTEROID_SPAWN_TIMER    200
#define DEF_LASER_SPAWN_TIMER       1000 //250
...
#endif //FERAL_ENGINE_MAXVALUES_H